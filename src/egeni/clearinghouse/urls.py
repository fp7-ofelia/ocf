...
urlpatterns = patterns('',
    ...
    url(r'^(?P<object_id>\d+)/detail/$', 'django.views.generic.list_detail.object_detail', info_dict, 'details'),
    ...
    (r'^(?P<object_id>\d+)/call_func/$', 'egeni.clearinghouse.views.call_func'),
)
