...
#print cred
credential = open('/opt/ofelia/expedient/src/python/sfa/sfi/topdomain.nitos.pi.user.cred','r')
...
print s.ListResources([credential.read()],{'cached': True, 'list_leases': 'resources', 'geni_rspec_version': {'type': 'SFA', 'version': '1', 'namespace': None, 'extensions': [], 'schema': None}, 'rspec_version': {'namespace': None, 'version': '1', 'type': 'SFA', 'extensions': [], 'schema': None}, 'call_id': 'urn:uuid:57a5ce8d-a668-497c-8e91-ba5c4b42d415'})
