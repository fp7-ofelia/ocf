...
from geni_api.utils.validators import TEMPERATURE_SCALE_CHOICES, validate_resource_name, validate_temperature_scale

class GeniApi(Resource):
    
    class Meta:
        """Meta class for GeniApi model."""
        app_label = 'geni_api'

    # Unique alphanumeric identifier for the GeniApi
    ...
    connections = models.ManyToManyField("GeniApi", blank = True, null = True)
