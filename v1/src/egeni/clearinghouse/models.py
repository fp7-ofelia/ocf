...
class Node(models.Model):
    ...
    LOCATION_DICT = {
        '0012e2786763': (22, 439),
        '002320e9f311': (604, 370),
        '0012e298a5d0': (24, 250),
        '0012e27831f3': (21, 331),
        '0012e2b8f3d2': (123, 344),
        '002320dce53a': (458, 465),
        '002320f412a4': (596, 31),
        '002320ec2128': (596, 160),
        '0012e298a5ce': (144, 418),
        '004e46324304': (19, 147),
        '00232033441c': (439, 323),
        '00232055661c': (307, 30),
        '00232011221c': (446, 28),
        '176001b3fc54700': (210, 34),
        'of-planet3.stanford.edu': (108, 493),
        'of-planet4.stanford.edu': (600, 486),
        'of-planet2.stanford.edu': (2, 508),
        'of-planet1.stanford.edu': (100, 205),
