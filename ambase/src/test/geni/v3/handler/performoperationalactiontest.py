...
class DeleteTest(unittest.TestCase):
    ...
    def should_perfor_opreational_action(self):
        pass
    
    def should_fail_when_invalid_action(self):
        pass
    
    def should_fail_when_inconsistent_action(self):
        pass
    
    def should_fail_when_perform_operational_state_exception(self):
        pass
    
    def should_send_correctly_formatted_ouptu(self):
        pass
    
    def should_send_correctly_formatted_error(self):
        pass
