...
from settings.loader import OXA_FILEHD_CACHE_VMS, OXA_FILEHD_REMOTE_VMS, OXA_FILEHD_CACHE_TEMPLATES, \
							OXA_FILEHD_REMOTE_TEMPLATES, OXA_FILEHD_USE_CACHE, OXA_FILEHD_NICE_PRIORITY, \
							OXA_FILEHD_CREATE_SPARSE_DISK, OXA_FILEHD_IONICE_CLASS, OXA_FILEHD_IONICE_PRIORITY, \
							OXA_FILEHD_DD_BS_KB, OXA_DEFAULT_SWAP_SIZE_MB
