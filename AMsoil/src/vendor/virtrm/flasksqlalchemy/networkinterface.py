...
from networkinterfaceips import NetworkInterfaceIp4s
from networkinterfaceconnectedto import NetworkInterfaceConnectedTo
from base import db
...
class NetworkInterface(db.Model):
    ...
    ips = association_proxy("networkinterface_ips", "ipslot")
