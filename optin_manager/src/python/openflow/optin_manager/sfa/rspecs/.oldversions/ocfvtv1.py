...
class OcfVt(RSpecVersion):
    ...
    content_type = 'ad'
    version = '1'
    schema = '/opt/ofelia/vt_manager/src/python/openflow.optin_manager/sfa/tests/vm_schema.xsd'#'http://www.protogeni.net/resources/rspec/2/ad.xsd'
...
class OcfVtAd(OcfVt):
    ...
    content_type = 'ad'
    schema = '/opt/ofelia/vt_manager/src/python/openflow.optin_manager/sfa/tests/vm_schema.xsd'#'http://www.protogeni.net/resources/rspec/2/ad.xsd'
    template = '<rspec type="advertisement" xmlns="http://www.protogeni.net/resources/rspec/2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.protogeni.net/resources/rspec/2 http://www.protogeni.net/resources/rspec/2/ad.xsd /opt/ofelia/vt_manager/src/python/openflow.optin_manager/sfa/tests/vm_schema.xsd"/>'
