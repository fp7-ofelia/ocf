...
@rpcmethod(signature=[SUCCESS_TYPE, URN_TYPE, CREDENTIALS_TYPE, OPTIONS_TYPE, CERT_TYPE], url_name=GAPI3_URL)
def Shutdown(slice_urn, credentials, options, caller_cert=None):
    return handler.Shutdown(slice_urn, credentials, options, caller_cert)
