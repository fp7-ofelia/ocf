...
class OcfVt(RSpecVersion):
    ...
    content_type = 'ad'
    version = '1'
    schema = 'https://github.com/fp7-ofelia/ocf/blob/ocf.rspecs/schema.xsd' #'/opt/ofelia/vt_manager/src/python/vt_manager/communication/sfa/tests/schema.xsd'#'http://www.protogeni.net/resources/rspec/2/ad.xsd'
