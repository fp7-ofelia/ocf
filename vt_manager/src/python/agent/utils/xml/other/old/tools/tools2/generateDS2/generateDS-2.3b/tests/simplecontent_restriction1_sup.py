...
class BillOfResourcesIDType(IdentifierType):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='BillOfResourcesIDType'):
        super(BillOfResourcesIDType, self).exportChildren(outfile, level, namespace_, name_)
        pass
    def hasContent_(self):
        if (
            self.valueOf_ or
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        super(BillOfResourcesIDType, self).buildChildren(child_, nodeName_, True)
        pass
...
class BillOfMaterialIDType(IdentifierType):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='BillOfMaterialIDType'):
        super(BillOfMaterialIDType, self).exportChildren(outfile, level, namespace_, name_)
        pass
    def hasContent_(self):
        if (
            self.valueOf_ or
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        super(BillOfMaterialIDType, self).buildChildren(child_, nodeName_, True)
        pass
